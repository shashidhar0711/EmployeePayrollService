...
update Employee_Payroll set Basic_Pay = 25000.00,Deductions = 2000.00,Taxable_Pay = 1500.00,Income_Tax = 1000.00,Net_Pay = 2500.00 where Id = 1;
...
Update Employee_Payroll set Department = 'Sales',PhoneNumber = '9073112156',Address = 'Vijay nagar' where Id = 2
...
insert into Salary values(10000,1000,1500,2500,900,'Jan',1);
insert into Salary values(20000,2000,2500,3500,1900,'Feb',2);
